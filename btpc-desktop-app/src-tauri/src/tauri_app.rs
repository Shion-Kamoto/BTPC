    ...
    tauri::Builder::default()
        ...
        .setup(move |app| {
            ...
            if !adopted.is_empty() {
                ...
                println!("No existing BTPC processes found");
            }

            // Set app handle and wallet manager in embedded node
            {
                println!("Setting up embedded node with app handle and wallet manager...");
                ...
                tauri::async_runtime::block_on(async move {
                    ...
                    println!("Embedded node setup complete");
                });
            }
            ...
            // Start session timeout monitor (15-minute timeout)
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::wallet_basic::send_btpc,
            // UTXO commands
            ...
            // Transaction commands (Feature 007)
