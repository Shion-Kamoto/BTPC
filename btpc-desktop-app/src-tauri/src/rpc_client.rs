...
impl RpcClient {
    ...
    pub async fn get_block(&self, block_hash: &str) -> Result<BlockInfo> {
        ...
        serde_json::from_value(result).map_err(|e| anyhow!("Failed to parse block info: {}", e))
    }
    ...
    pub async fn get_block_hash(&self, height: u64) -> Result<String> {
        ...
        serde_json::from_value(result).map_err(|e| anyhow!("Failed to parse block hash: {}", e))
    }
    ...
    pub async fn send_raw_transaction(&self, hex: &str) -> Result<String> {
        ...
        serde_json::from_value(result).map_err(|e| anyhow!("Failed to parse transaction ID: {}", e))
    }
    ...
    pub async fn get_utxos_for_address(&self, address: &str) -> Result<Vec<UTXOInfo>> {
        ...
        serde_json::from_value(result).map_err(|e| anyhow!("Failed to parse UTXO list: {}", e))
    }
    ...
    pub async fn get_network_info(&self) -> Result<NetworkInfo> {
        ...
        serde_json::from_value(result).map_err(|e| anyhow!("Failed to parse network info: {}", e))
    }
    ...
    pub async fn get_block_count(&self) -> Result<u64> {
        ...
        serde_json::from_value(result).map_err(|e| anyhow!("Failed to parse block count: {}", e))
    }

    /// Get difficulty
    pub async fn get_difficulty(&self) -> Result<f64> {
        let result = self.call("getdifficulty", None).await?;
        serde_json::from_value(result).map_err(|e| anyhow!("Failed to parse difficulty: {}", e))
    }
    ...
    pub async fn get_raw_mempool(&self) -> Result<Vec<String>> {
        ...
        serde_json::from_value(result).map_err(|e| anyhow!("Failed to parse mempool: {}", e))
    }
    ...
    pub async fn get_block_template(&self) -> Result<BlockTemplate> {
        ...
        serde_json::from_value(result).map_err(|e| anyhow!("Failed to parse block template: {}", e))
    }
