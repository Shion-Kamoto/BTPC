...
mod tests {
    ...
    fn test_timeout_error_display() {
        ...
        assert_eq!(TimeoutError::Idle.to_string(), "Idle connection timeout");
    }

    #[test]
    fn test_network_config_includes_timeouts() {
        let mainnet_config = NetworkConfig::mainnet();
        assert_eq!(mainnet_config.timeouts.tcp_connect, Duration::from_secs(10));
        assert_eq!(
        ...
        assert_eq!(testnet_config.timeouts.tcp_connect, Duration::from_secs(10));
        assert_eq!(
